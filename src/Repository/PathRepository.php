...
final class PathRepository {
	...
	public function find_all(): array {
		...
		$rows = $this->wpdb->get_results(
			"SELECT id, name, description, status, start_checkpoint_id, finish_checkpoint_id, opening_date, closing_date, created_at, updated_at FROM {$this->table_name} ORDER BY name ASC",
			ARRAY_A
		);
